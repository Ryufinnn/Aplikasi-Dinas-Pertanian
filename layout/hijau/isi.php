 ...
 <!------------- TABS BERITA -------------------->
  ...
  <b>Kepala Dinas Pertanian</b><br>
  <div class="photos">
    <img width="150" height="100" src="foto_sambutan/ibuk.jpg" />
      Assalamu'alaikum wr.wb
      
      <br>
      Selamat datang di Website resmi Dinas Pertanian Kota Payakumbuh. Puji Syukur kepada Allah SWT, atas karunia dan hidayahNya website Dinas Pertanian Kota Payakumbuh bisa terealisasi dan dapat diakses oleh masyarakat luas.<br><br>
    
    <div class="sidebar-title"><b>Sambutan</b></div>
   <div class="photos"> <p><b>Wali Kota</b></p>
  <img width="150"  src="foto_sambutan/sambutan-walikota.jpg" />
  <div class="photos"> <p><b>Ketua DPRD</b></p>
  <img width="150"  src="foto_sambutan/sambutan-dprd.jpg" />
  ...
  */
  ...
  echo "<a href='bapeda.payakumbuh.go.id' 'target='_blank' >
  <img width=250 src='foto_sambutan/bappeda-pyk.jpg' border=0></a>";
   echo "<a href='bpmd.payakumbuh.go.id' 'target='_blank' >
  <img width=250 src='foto_sambutan/bpmd-ptsp.jpg' border=0></a>";
   echo "<a href='pu.payakumbuh.go.id' 'target='_blank' >
  <img width=250 src='foto_sambutan/dinas-pekerjaan-umum-banner.jpg' border=0></a>";
