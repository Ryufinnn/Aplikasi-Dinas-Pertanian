...
<th width="18%" bgcolor="#999999"><span class="style3">Indikator Kinerja</span></th>
<th width="19%" bgcolor="#999999"><span class="style3">Capaian Sebelumnya (ton)</span></th>
<th width="9%" bgcolor="#999999"><span class="style3">Target (ton)</span></th>
<th width="11%" bgcolor="#999999"><span class="style3">Realisasi (ton)</span></th>
<th width="12%" bgcolor="#999999"><span class="style3">Nilai Capaian %</span></th>
<th width="6%" bgcolor="#999999"><span class="style3">Kategori</span></th>
<th width="9%" bgcolor="#999999"><span class="style3">Target Akhir</span></th>
<th width="11%" bgcolor="#999999"><span class="style3">Capaian Akhir</span></th>
...
<?php
$sql = mysql_query("select * from lakip  order by id_lakip desc");
$no=1;
...
<td class='td' ><span class="style3"><?echo"$r[indikator_kinerja]";?></span></td>
<td class='td'  ><span class="style3"><?php echo number_format($r['capaian_sblm']);?></span></td>

<td class='td' align="center"><span class="style3"><?php echo number_format($r['target']);?> </td>
<td class='td' align="center"><span class="style3"><?php echo number_format($r['realisasi']);?> </td>
<td class='td' align="center"><span class="style3"><?echo"$r[nilai]";?> </td>
<td class='td' align="center"><span class="style3"><?echo"$r[kategori]";?> </td>
<td class='td' align="center"><span class="style3"><?php echo number_format($r['target_akhir']);?> </td>
<td class='td' align="center"><span class="style3"><?echo"$r[capaian_akhir]";?> </td>
